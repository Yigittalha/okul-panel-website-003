...
@Component({
  ...
  template: `
    <div class="min-h-screen">
      ...
      <main class="pt-20">
        <!-- Header -->
        <section class="section py-10 text-white" style="background: linear-gradient(to right, #0D1B2A, #0c4a6e, #0D1B2A);">
        ...
        <!-- Story -->
        <section class="section py-20" style="background: linear-gradient(to right, #0D1B2A, #0c4a6e, #0D1B2A);">
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="prose prose-lg max-w-none">
              <h2 class="text-3xl font-bold text-white mb-8">Hikayemiz</h2>
        ...
        <section class="section py-20" style="background: linear-gradient(to right, #0D1B2A, #0c4a6e, #0D1B2A);">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-white mb-12 text-center" [@fadeIn]>Değerlerimiz</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8" [@stagger]>
              <div class="text-center" [@slideUp]>
                ...
                <h3 class="text-xl font-semibold text-white mb-3">Güvenilirlik</h3>
              ...
              <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-3">Yenilikçilik</h3>
                <p class="text-white/80">
              ...
              <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-3">Müşteri Odaklılık</h3>
                <p class="text-white/80">
